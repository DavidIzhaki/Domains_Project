(define (problem redcar-instance-1)
  ...
  (:objects
    red-car pink-car white-car  - horizontalCar
    blue-car purple-car green-car green-over-car orange-car - verticalCar
