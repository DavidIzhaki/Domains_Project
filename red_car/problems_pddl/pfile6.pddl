(define (problem redcar-instance-1)
  ...
  (:objects
    red-car blue-car yellow-car green-car purple-car brown-car - horizontalCar
    yellow-over-car white-car pink-car green-over-car orange-car - verticalCar
  ...
  (:init
    ...
    ;; Clear cells (as predicates!)
                                                            ...
                                                            (clear p4 p2) 
    (clear p0 p3) (clear p1 p3) (clear p2 p3) 
                                                                         (clear p5 p4)
