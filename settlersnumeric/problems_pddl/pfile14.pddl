...
(:init
	...
	(potential vehicle14)
        ...
        (= (available timber vehicle10) 0)
        (= (available wood vehicle10) 0)
        (= (available coal vehicle10) 0)
        (= (available stone vehicle10) 0)
        (= (available iron vehicle10) 0)
        (= (available ore vehicle10) 0)
        (= (space-in vehicle10) 0)

        (= (available timber vehicle11) 0)
        (= (available wood vehicle11) 0)
        (= (available coal vehicle11) 0)
        (= (available stone vehicle11) 0)
        (= (available iron vehicle11) 0)
        (= (available ore vehicle11) 0)
        (= (space-in vehicle11) 0)

        (= (available timber vehicle12) 0)
        (= (available wood vehicle12) 0)
        (= (available coal vehicle12) 0)
        (= (available stone vehicle12) 0)
        (= (available iron vehicle12) 0)
        (= (available ore vehicle12) 0)
        (= (space-in vehicle12) 0)

        (= (available timber vehicle13) 0)
        (= (available wood vehicle13) 0)
        (= (available coal vehicle13) 0)
        (= (available stone vehicle13) 0)
        (= (available iron vehicle13) 0)
        (= (available ore vehicle13) 0)
        (= (space-in vehicle13) 0)

        (= (available timber vehicle14) 0)
        (= (available wood vehicle14) 0)
        (= (available coal vehicle14) 0)
        (= (available stone vehicle14) 0)
